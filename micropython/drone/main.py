...
adc_MQ_7 = machine.ADC(37)
adc_MQ_135 = machine.ADC(36)
adc_MQ_7.atten(adc_MQ_7.ATTN_6DB) #2.5 V
adc_MQ_135.atten(adc_MQ_135.ATTN_6DB) #2.5V
#adc_MQ_7.width(adc_MQ_7.WIDTH_10BIT)
#adc_MQ_135.width(adc_MQ_135.WIDTH_10BIT)
...
while 1:
    ...
    if send_flag==True:
        ...
        if offline_flag:
            ...
            u_7 = adc_MQ_7.read() * 2.5 / 2048
            R_MQ_7 = 1e3  * u_7 /(3.3 - u_7)
            u_135 = adc_MQ_135.read() * 2.5 / 2048
            R_MQ_135 = 1e3 * u_135/ (3.3- u_135)
            data_str += " " + str(round(R_MQ_7, 1))
            data_str += " " + str(round(R_MQ_135, 1))
            data_str += "\n\r"
            print(str(adc_MQ_7.read()) + " " +str(u_7) + " " + str(R_MQ_7))
            print(str(adc_MQ_135.read()) + " " + str(u_135) + " " + str(R_MQ_135))
